...
console.log("Elon Musk".split(' '));

const [firstName, lastName] = "Elon Musk".split(' ');
...
capitalizeName("elon musk");

// Padding
const message = "Go to gate 23!";
console.log(message.padStart(25, '+').padEnd(30, '+'));
console.log("Dice-K".padStart(20, '+').padEnd(30, '+'));
...
maskCreditCard(431987234987234897);
maskCreditCard("2349872384723894723847");
